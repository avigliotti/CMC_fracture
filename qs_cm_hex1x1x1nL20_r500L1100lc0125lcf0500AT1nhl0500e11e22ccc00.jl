...
run_phase_field_qspso(sModelName="cm_hex2x2x1nL20_r500L1100lc0125lcf0500", 
                     ϵM0=[1.000, 0.000, 0.000, NaN, NaN, NaN]*7.558e-03, 
                     θ=0.000000, ψ=0.000000, ζ=0.000000,
                     fiber_mat=fiber_mat, matrix_mat=matrix_mat,
                     nSteps=501, nwritevtu=5, 
                     maxiter=5, λV=1.00e+00, λT=1.00e-02,
                     maxiteru=3,maxδdTol=5.000e-02, 
                     dTolu=1.0e-03, dTold=Inf, Nupdtmax=10, Nupdtmin=10,
                     sPost="AT1nhl0500e11e22ccc00")
